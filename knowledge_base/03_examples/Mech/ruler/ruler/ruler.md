...
| 文件名 | WavEDA 相对路径 | 用途 |
| --- | --- | --- |
| Rules_1.png | `Example/Mech/ruler/ruler/res/Rules_1.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Rules_6.png | `Example/Mech/ruler/ruler/res/Rules_6.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Rules_10.png | `Example/Mech/ruler/ruler/res/Rules_10.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Rules_11.png | `Example/Mech/ruler/ruler/res/Rules_11.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
