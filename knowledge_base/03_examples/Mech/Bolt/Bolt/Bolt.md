...
| 文件名 | WavEDA 相对路径 | 用途 |
| --- | --- | --- |
| Bolt_1.png | `Example/Mech/Bolt/Bolt/res/Bolt_1.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Bolt_4.png | `Example/Mech/Bolt/Bolt/res/Bolt_4.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Bolt_9.png | `Example/Mech/Bolt/Bolt/res/Bolt_9.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Bolt_10.png | `Example/Mech/Bolt/Bolt/res/Bolt_10.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
