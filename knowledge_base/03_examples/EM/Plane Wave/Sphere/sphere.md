...
| 文件名 | WavEDA 相对路径 | 用途 |
| --- | --- | --- |
| Sphere_1.png | `Example/EM/Plane Wave/Sphere/res/Sphere_1.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Sphere_2.png | `Example/EM/Plane Wave/Sphere/res/Sphere_2.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Sphere_8.png | `Example/EM/Plane Wave/Sphere/res/Sphere_8.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Sphere_9.png | `Example/EM/Plane Wave/Sphere/res/Sphere_9.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
