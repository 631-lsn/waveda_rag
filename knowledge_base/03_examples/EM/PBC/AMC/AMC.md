...
| 文件名 | WavEDA 相对路径 | 用途 |
| --- | --- | --- |
| AMC_1.png | `Example/EM/PBC/AMC/res/AMC_1.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| AMC_2.png | `Example/EM/PBC/AMC/res/AMC_2.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| AMC_8.png | `Example/EM/PBC/AMC/res/AMC_8.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| AMC_9.png | `Example/EM/PBC/AMC/res/AMC_9.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
