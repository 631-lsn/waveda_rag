...
| 文件名 | WavEDA 相对路径 | 用途 |
| --- | --- | --- |
| PBGA_1.png | `Example/Multi-Physics/PBGA/PBGA/res/PBGA_1.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| PBGA_4.png | `Example/Multi-Physics/PBGA/PBGA/res/PBGA_4.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| PBGA_9.png | `Example/Multi-Physics/PBGA/PBGA/res/PBGA_9.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| PBGA_10.png | `Example/Multi-Physics/PBGA/PBGA/res/PBGA_10.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
