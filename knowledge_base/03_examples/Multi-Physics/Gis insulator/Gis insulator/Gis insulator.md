...
| 文件名 | WavEDA 相对路径 | 用途 |
| --- | --- | --- |
| GIS_insulator_1.png | `Example/Multi-Physics/Gis insulator/Gis insulator/res/GIS_insulator_1.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| GIS_insulator_3.png | `Example/Multi-Physics/Gis insulator/Gis insulator/res/GIS_insulator_3.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| GIS_insulator_6.png | `Example/Multi-Physics/Gis insulator/Gis insulator/res/GIS_insulator_6.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| GIS_insulator_7.png | `Example/Multi-Physics/Gis insulator/Gis insulator/res/GIS_insulator_7.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
