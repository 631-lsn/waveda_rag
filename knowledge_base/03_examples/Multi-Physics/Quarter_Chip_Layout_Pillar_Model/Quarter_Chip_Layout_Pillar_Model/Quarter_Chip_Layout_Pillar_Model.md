...
| 文件名 | WavEDA 相对路径 | 用途 |
| --- | --- | --- |
| Quarter_Chip_Layout_Pillar_Model1.png | `Example/Multi-Physics/Quarter_Chip_Layout_Pillar_Model/Quarter_Chip_Layout_Pillar_Model/res/Quarter_Chip_Layout_Pillar_Model1.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Quarter_Chip_Layout_Pillar_Model5.png | `Example/Multi-Physics/Quarter_Chip_Layout_Pillar_Model/Quarter_Chip_Layout_Pillar_Model/res/Quarter_Chip_Layout_Pillar_Model5.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Quarter_Chip_Layout_Pillar_Model11.png | `Example/Multi-Physics/Quarter_Chip_Layout_Pillar_Model/Quarter_Chip_Layout_Pillar_Model/res/Quarter_Chip_Layout_Pillar_Model11.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| Quarter_Chip_Layout_Pillar_Model7.png | `Example/Multi-Physics/Quarter_Chip_Layout_Pillar_Model/Quarter_Chip_Layout_Pillar_Model/res/Quarter_Chip_Layout_Pillar_Model7.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
