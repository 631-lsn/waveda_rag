...
| 文件名 | WavEDA 相对路径 | 用途 |
| --- | --- | --- |
| PKG_WB_Model_1.png | `Example/Multi-Physics/PKG_WB_Model/PKG_WB_Model/res/PKG_WB_Model_1.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| PKG_WB_Model_3.png | `Example/Multi-Physics/PKG_WB_Model/PKG_WB_Model/res/PKG_WB_Model_3.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| PKG_WB_Model_6.png | `Example/Multi-Physics/PKG_WB_Model/PKG_WB_Model/res/PKG_WB_Model_6.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
| PKG_WB_Model_7.png | `Example/Multi-Physics/PKG_WB_Model/PKG_WB_Model/res/PKG_WB_Model_7.png` | 展示该案例中的关键模型、设置或结果，后续审查后决定是否补图。 |
