...
source_relative_path: "Tool/Variables.html"
...
> 图示要点：`Variables_1.png` 展示“变量”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`Variables_3.png` 展示“绘制”相关的操作界面或示例，后续审查通过后再补图。
...
| 图片名称 | 当前资源路径 | 建议保留原因 |
| --- | --- | --- |
| Variables_1.png | `wavEDA_docs/helpHtml/helpHtml/Tool/images/Variables_1.png` | 展示“变量”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Variables_3.png | `wavEDA_docs/helpHtml/helpHtml/Tool/images/Variables_3.png` | 展示“绘制”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
