...
| --- | --- | --- |
| Export_Snp1.png | `Tool/images/Export_Snp1.png` | 展示“SNP导出选项”步骤的菜单或参数界面，便于新人按界面完成操作。 |
| Export_Snp2.png | `Tool/images/Export_Snp2.png` | 展示“SNP导出选项”步骤的菜单或参数界面，便于新人按界面完成操作。 |
