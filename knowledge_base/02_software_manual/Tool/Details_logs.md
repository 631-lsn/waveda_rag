...
| --- | --- | --- |
| Details_logs1.png | `Tool/images/Details_logs1.png` | 展示“详细信息”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Details_logs2.png | `Tool/images/Details_logs2.png` | 展示“网格”的结果入口或查看界面，便于新人确认后处理位置。 |
| Details_logs3.png | `Tool/images/Details_logs3.png` | 展示“网格数量”的结果入口或查看界面，便于新人确认后处理位置。 |
