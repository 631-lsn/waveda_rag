...
source_relative_path: "Mesh/3D_Mesh.html"
...
> 图示要点：`3D_Mesh_1.png` 展示“3D网格”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`3D_Mesh_2.png` 展示“WavEDA网格剖分流程：”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`3D_Mesh_3.png` 展示“初始网格设置：”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`3D_Mesh_4.png` 展示“局部网格加密”相关的操作界面或示例，后续审查通过后再补图。

WavEDA也支持在工程树和模型显示界面选中物体后右击-->属性-->修改网格尺寸，在弹出的局部网格尺寸定义窗口中输入局部加密参数。

> 图示要点：`3D_Mesh_5.png` 展示“局部网格加密”相关的操作界面或示例，后续审查通过后再补图。

> 图示要点：`3D_Mesh_6.png` 展示“局部网格加密”相关的操作界面或示例，后续审查通过后再补图。

> 图示要点：`3D_Mesh_7.png` 展示“局部网格加密”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`3D_Mesh_8.png` 展示“局部网格加密”相关的操作界面或示例，后续审查通过后再补图。

> 图示要点：`3D_Mesh_9.png` 展示“局部网格加密”相关的操作界面或示例，后续审查通过后再补图。

> 图示要点：`3D_Mesh_10.png` 展示“局部网格加密”相关的操作界面或示例，后续审查通过后再补图。

> 图示要点：`3D_Mesh_11.png` 展示“局部网格加密”相关的操作界面或示例，后续审查通过后再补图。
