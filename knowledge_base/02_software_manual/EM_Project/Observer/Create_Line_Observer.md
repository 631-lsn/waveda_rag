...
| --- | --- | --- |
| Create_Line_Observer_1.png | `EM_Project/Observer/images/Create_Line_Observer_1.png` | 展示“创建线接收器”步骤的菜单或参数界面，便于新人按界面完成操作。 |
| Create_Line_Observer_2.png | `EM_Project/Observer/images/Create_Line_Observer_2.png` | 展示“直线”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Create_Line_Observer_3.png | `EM_Project/Observer/images/Create_Line_Observer_3.png` | 展示“椭圆曲线”的结果入口或查看界面，便于新人确认后处理位置。 |
| Create_Line_Observer_4.png | `EM_Project/Observer/images/Create_Line_Observer_4.png` | 展示“椭圆曲线”的结果入口或查看界面，便于新人确认后处理位置。 |
| Create_Line_Observer_5.png | `EM_Project/Observer/images/Create_Line_Observer_5.png` | 展示“椭圆曲线”的结果入口或查看界面，便于新人确认后处理位置。 |
| Create_Line_Observer_6.png | `EM_Project/Observer/images/Create_Line_Observer_6.png` | 展示“椭圆曲线”的结果入口或查看界面，便于新人确认后处理位置。 |
| Create_Line_Observer_7.png | `EM_Project/Observer/images/Create_Line_Observer_7.png` | 展示“参数化曲线”的结果入口或查看界面，便于新人确认后处理位置。 |
