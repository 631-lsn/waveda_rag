...
| --- | --- | --- |
| Multi_Conductors_1.png | `Modeling/Stimulate/images/Multi_Conductors_1.png` | 展示“波端口多导体”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Multi_Conductors_2.png | `Modeling/Stimulate/images/Multi_Conductors_2.png` | 展示“模式设置方法”步骤的菜单或参数界面，便于新人按界面完成操作。 |
| Multi_Conductors_4.png | `Modeling/Stimulate/images/Multi_Conductors_4.png` | 展示“模式设置方法”步骤的菜单或参数界面，便于新人按界面完成操作。 |
| Multi_Conductors_7.png | `Modeling/Stimulate/images/Multi_Conductors_7.png` | 展示“模式设置方法”步骤的菜单或参数界面，便于新人按界面完成操作。 |
| Multi_Conductors_6.png | `Modeling/Stimulate/images/Multi_Conductors_6.png` | 展示“模式设置方法”步骤的菜单或参数界面，便于新人按界面完成操作。 |
| Multi_Conductors_3.png | `Modeling/Stimulate/images/Multi_Conductors_3.png` | 展示“终端设置方法”步骤的菜单或参数界面，便于新人按界面完成操作。 |
| Multi_Conductors_5.png | `Modeling/Stimulate/images/Multi_Conductors_5.png` | 展示“终端设置方法”步骤的菜单或参数界面，便于新人按界面完成操作。 |
| Multi_Conductors_8.png | `Modeling/Stimulate/images/Multi_Conductors_8.png` | 展示“终端设置方法”步骤的菜单或参数界面，便于新人按界面完成操作。 |
