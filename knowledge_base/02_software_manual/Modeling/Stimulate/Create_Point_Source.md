...
| --- | --- | --- |
| Create_Point_Source_1.png | `Modeling/Stimulate/images//Create_Point_Source_1.png` | 展示“点激励源的应用场景：”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Create_Point_Source_2.png | `Modeling/Stimulate/images/Create_Point_Source_2.png` | 展示“形式”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Create_Point_Source_6.png | `Modeling/Stimulate/images/Create_Point_Source_6.png` | 展示“阵列排序”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Create_Point_Source_5.png | `Modeling/Stimulate/images/Create_Point_Source_5.png` | 展示“阵列排序”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
