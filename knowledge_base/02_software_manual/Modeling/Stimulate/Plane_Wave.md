...
source_relative_path: "Modeling/Stimulate/Plane_Wave.html"
...
> 图示要点：`Plane_Wave_1.png` 展示“平面波”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`Plane_Wave_2.png` 展示“平面波激励源的主要应用场景包括：”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`Plane_Wave_17.png` 展示“参考坐标系”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`Plane_Wave_18.png` 展示“线极化：”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`Plane_Wave_3.png` 展示“线极化：”相关的操作界面或示例，后续审查通过后再补图。

> 图示要点：`Plane_Wave_7.png` 展示“线极化：”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`Plane_Wave_8.png` 展示“圆极化:”相关的操作界面或示例，后续审查通过后再补图。

- 左圆极化和右圆极化

两者的主要区别在于电场旋转方向和相位关系的不同，如右旋圆极化电场矢量在垂直于传播方向的平面上以顺时针方向旋转。对于圆极化，轴比始终为1，相移为-90°时平面波为左旋圆极化，相移为90°时平面波为右旋圆极化。

> 图示要点：`Plane_Wave_4.png` 展示“圆极化:”相关的操作界面或示例，后续审查通过后再补图。

> 图示要点：`Plane_Wave_5.png` 展示“圆极化:”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`Plane_Wave_19.png` 展示“椭圆极化:”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`Plane_Wave_6.png` 展示“椭圆极化:”相关的操作界面或示例，后续审查通过后再补图。

> 图示要点：`Plane_Wave_9.png` 展示“椭圆极化:”相关的操作界面或示例，后续审查通过后再补图。
...
> 图示要点：`Plane_Wave_11.png` 展示“平面波实例”相关的操作界面或示例，后续审查通过后再补图。

> 图示要点：`Plane_Wave_12.png` 展示“平面波实例”相关的操作界面或示例，后续审查通过后再补图。

在WavEDA内，用户可查看该模型的单站雷达散射截面，也可以查看其他的3D远场结果。

> 图示要点：`Plane_Wave_13.png` 展示“平面波实例”相关的操作界面或示例，后续审查通过后再补图。

> 图示要点：`Plane_Wave_14.png` 展示“平面波实例”相关的操作界面或示例，后续审查通过后再补图。
