...
| --- | --- | --- |
| Extended_Operations_1.png | `Modeling/Model_Editing/images/Extended_Operations_1.png` | 展示“在选定面上创建一个面”步骤的菜单或参数界面，便于新人按界面完成操作。 |
| Extended_Operations_2.png | `Modeling/Model_Editing/images/Extended_Operations_2.png` | 展示“移除特征”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Extended_Operations_3.png | `Modeling/Model_Editing/images/Extended_Operations_3.png` | 展示“在选定面上对齐体”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Extended_Operations_4.png | `Modeling/Model_Editing/images/Extended_Operations_4.png` | 展示“连接”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Extended_Operations_5.png | `Modeling/Model_Editing/images/Extended_Operations_5.png` | 展示“基于LCS(UV)切割物体”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
