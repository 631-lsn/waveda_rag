...
| --- | --- | --- |
| Polygon_1.png | `Modeling/Create_Face/images/Polygon_1.png` | 展示“多边形”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Polygon_2.png | `Modeling/Create_Face/images/Polygon_2.png` | 展示“规则多边形复选框”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
