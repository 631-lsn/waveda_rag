...
source_relative_path: "Modeling/Create_Face/Semiellipsoid_Face.html"
...
> 图示要点：`Semiellipsoid_Face_1.png` 展示“半椭球面”相关的操作界面或示例，后续审查通过后再补图。
...
| 图片名称 | 当前资源路径 | 建议保留原因 |
| --- | --- | --- |
| Semiellipsoid_Face_1.png | `wavEDA_docs/helpHtml/helpHtml/Modeling/Create_Face/images/Semiellipsoid_Face_1.png` | 展示“半椭球面”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
