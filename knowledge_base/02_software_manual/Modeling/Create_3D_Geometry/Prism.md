...
| --- | --- | --- |
| Prism_1.png | `Modeling/Create_3D_Geometry/images/Prism_1.png` | 展示“棱柱”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
| Prism_2.png | `Modeling/Create_3D_Geometry/images/Prism_2.png` | 展示“规则多边形复选框”相关界面或示例，后续审查时判断是否需要作为辅助配图。 |
